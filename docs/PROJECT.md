...
src-tauri/src/
  ...
  commands.rs   Tauri IPC: mutations + broadcast, settings import/export, logs, media import/search, NDI, MIDI/OSC/triggers, scripture import/search, templates (save/load)
